        ...
        <div class="">
            <div class="">
                ...
                <div class="row mt-4 align-items-center">
                    ...
                    <div class="col-lg-3 userLogin grab" href="#tets">
                        <div class="card mb-4">
                            <div class="card-body">
                    ...
                    <div class="col-lg-3 menuAccess grab">
                        <div class="card mb-4">
                            <div class="card-body">
                ...
                <div class="card m-b-30">
                    ...
                    <div class="card-body" id="tableOfGroupUsers">
                        <div class="row">
                            ...
                            <div class="col">
                                <button class="btn btn-primary mt-0 float-right" data-toggle="modal" data-target="#modalGroupUsers">Add New Group</button>
                            </div>
                        </div>
                        <hr>
                            ...
                            <div class="col-md-4">
                                <form id="formSaveMenu">
                                    <div class="mb-2">
                                        ...
                                        <input type="email" class="form-control col-4" name="menu_id" id="exampleInputEmail1" aria-describedby="emailHelp">
                                    </div>

                                    <div class="mb-2">
                                        <label for="exampleInputPassword1" class="form-label">Menu Level</label>
                                        <select class="form-control select2 col-md-4" id="menuLevel" name="menu_level">
                                            <option value="1">Menu Level 1</option>
                                            <option value="2">Menu Level 2</option>
                                            <option value="3">Menu Level 3</option>
                                        </select>
                                    </div>

                                    <div class="mb-2 form-menu-header">
                                        <label for="exampleInputPassword1" class="form-label">Menu Header</label>
                                        <select class="form-control select-search col-md-8" name="header" id="selectMenu">
                                        </select>
                                    </div>

                                    <div class="mb-2">
                                        <label for="exampleInputPassword1" class="form-label">Title</label>
                                        <input type="" class="form-control" name="title" id="exampleInputPassword1">
                                    </div>
                                    <div class="mb-2">
                                        <label for="exampleInputPassword1" class="form-label">Link</label>
                                        <input type="" class="form-control" name="link" id="exampleInputPassword1">
                                    </div>
                                    <div class="mb-2">
                                    ...
                                    <button class="btn btn-primary mt-3 btn-save-menu" type="button" id="btnSaveMenu">Save</button>
                                </form>
                            </div>
                    ...
                    <!-- List Of Menu Access -->
                    <div class="card-body" id="tableOfMenuAccess">
                        <form id="formSaveAccessMenu">
                            <div class="row">
                                <div class="col">
                                    <h4 class="header-title">Menu Access Management</h4>
                                </div>
                                <div class="col">
                                    <button class="btn btn-primary mt-0 float-right col-3 btn-save-access-menu" id="btn-save" type="button">Save</button>
                                    <div class="float-right mt-2 mr-2">
                                        <input name='menu_id[]' type='checkbox' id='blankCheckbox' aria-label='...'> Check All
                                    </div>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                <div class="col-md-4">
                                    <form>
                                        <div class="mb-2">
                                            <label for="exampleInputEmail1" class="form-label">Group User</label>
                                            <select name="group_id" class="form-control select-search" id="group_id">
                                                <?Php foreach ($listOfGroup as $item) {
                                                    echo "<option value='$item->user_group_id'>$item->user_group_name</option>";
                                                } ?>
                                            </select>
                                        </div>
                                    ...
                                    <!-- <div class="listFactor/yAccess"></div> -->
                                </div>
                                <div class="col-md-8 table-responsive" style="height: 500px;">
                                    <div class="custom-dd dd col-md-12" id="nestable_list_2">
                                        <div id="loadMenuAccessList"></div>
                                    </div>
...
<!-- Modal -->
<div class="modal fade" id="modalGroupUsers" tabindex="-1" role="dialog" aria-labelledby="modalGroupUsersTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Group User Create</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form id="formGroupUser">
                <div class="modal-body">
                    <div class="form-group">
                        <label for="exampleInputEmail1">Group Name</label>
                        <input type="text" class="form-control" name="user_group_name">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Group Remarks</label>
                        <input type="text" class="form-control" name="user_group_remark">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Is Active</label>
                        <select class="form-control" name="not_active">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary btn-group-user" id="btnSaveGroupUser">Save changes</button>
                </div>
            </form>
        </div>
    </div>
