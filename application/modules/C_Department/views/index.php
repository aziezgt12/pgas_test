    ...
    <div class="col-xl-12">
        <div class="card m-b-30">
            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="mb-3 col-md-4 ml-2 row">
...
<script>
  ...
  $(document).on('click', '.open-modal', function() {
            ...
            $("#exampleModalLongTitle").html("Form Create Department")
    ...
    function getAjax(dept = null){


        $.ajax({
            url: '<?php echo base_url('C_Department/getAjax'); ?>', // Ganti 'controller' sesuai dengan nama controller Anda
            method: 'POST',
            data: { 
                'deptId' : dept 
            },
        ...
        Swal.fire({
            ...
            preConfirm: function() {
                return new Promise(function(resolve) {
                    $.ajax({
                        type: "post",
                        url: "<?= base_url("C_Department/save") ?>",
        ...
        Swal.fire({
            ...
            preConfirm: function() {
                return new Promise(function(resolve) {
                    ...
                    $.ajax({
                        type: "post",
                        url: "<?= base_url("C_Department/delete") ?>",
                        data: {
                            'id' : id
                        },
                        dataType: "json",
